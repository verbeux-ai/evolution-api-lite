...
export class ChannelStartupService {
  ...
  public async fetchChats(query: any) {
    ...
    const results = await this.prismaRepository.$queryRaw`
      WITH rankedMessages AS (SELECT DISTINCT ON ("Contact"."remoteJid") "Contact"."id",
                                                                         "Contact"."remoteJid",
                                                                         "Contact"."pushName",
                              ...
                              FROM "Contact"
                                ...
                                AND "Message"."instanceId" = "Contact"."instanceId"
